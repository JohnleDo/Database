        ...
        try
        {
            ...
            switch (choice)
            {
                ...
                case 7:
                        ...
                        break;
                default: // Illegal choice for integers other than 1, 2 and 3.// File: Menu.java
//
// This program illustrates the use of a menu, which would be the basis
// for constructing a larger program by adding more options, where each
// option is handled by a separate function.
...
public static void DatabaseDeleteQuery(Connection conn, int tablechoice) throws SQLException
{
    ...
    // Variable for Team Table
    int TID;

    // Variable for Player Table
    int PID;

    // Variable for Player Stat Table
    int PSID;

    // Variable for General Manager Table
    int GMID;

    // Variable for Owner Table
    int OID;

    // Variable for Coach Table
    int CID;

    // Variable for Home Table
    int HID;
    ...
    switch (tablechoice)
    {
        case 1:
                ...
                break;
        case 2:
                System.out.print("Please enter a PID to delete: ");
                PID = keyboard.nextint();
        ...
        case 5:
                ...
                qry = String.format("Dete From Owner Where OID=%d”, OID);
                rs = stmt.executeQuery(qry);
